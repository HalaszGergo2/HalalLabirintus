 ...
 */
public class Atmaszol extends javax.swing.JFrame {

    /**
     * Creates new form Atmaszol
     */
    public Atmaszol() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Atmaszol.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
